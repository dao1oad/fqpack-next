...
def _install_route_stubs(monkeypatch):
    ...
    chanlun_structure_service = types.ModuleType("freshquant.chanlun_structure_service")
    chanlun_structure_service.get_chanlun_structure = lambda *args, **kwargs: {}
    ...
    util_period = types.ModuleType("freshquant.util.period")
    ...
    monkeypatch.setitem(
        sys.modules,
        "freshquant.chanlun_structure_service",
    ...
    monkeypatch.setitem(sys.modules, "freshquant.util.period", util_period)
...
def test_get_stock_position_list_serializes_enriched_position_names(stock_routes):
    stock_routes.get_stock_positions = lambda: [
        {
            "symbol": "sz002594",
            ...
            "quantity": 100,
            "amount": -999.995,
            "amount_adjusted": -1000.126,
        }
    ]

    response = stock_routes.get_stock_position_list()
