...
def test_clickhouse_store_list_traces_preview_preserves_raw_line_order_with_same_millisecond_ts(
    monkeypatch,
):
    from freshquant.runtime_observability.clickhouse_store import (
        RuntimeObservabilityClickHouseStore,
    ...
    def _fake_select_rows(query: str):
        ...
        if len(queries) == 1:
            return [
                {
                    "trace_key": "trace__trc_preview_same_ms",
                    "trace_id": "trc_preview_same_ms",
                    "trace_kind": "guardian_signal",
                    "trace_status": "broken",
                    "break_reason": "skipped@guardian_strategy.price_threshold_check:sell_threshold_not_met",
                    "first_ts": "2026-03-30 14:58:04.488",
                    "last_ts": "2026-03-30 14:58:05.185",
                    "duration_ms": 697,
                    "entry_component": "guardian_strategy",
                    "entry_node": "receive_signal",
                    "exit_component": "guardian_strategy",
        ...
        return [
            {
                "event_id": "evt_same_ms_1",
                "session_key": "trace__trc_preview_same_ms",
                "ts": "2026-03-30 14:58:04.488",
                "runtime_node": "host:guardian",
                "component": "guardian_strategy",
                "node": "receive_signal",
                "status": "info",
                ...
                "metrics_json": "{}",
                "raw_json": "{}",
                "raw_file": "host_guardian/guardian_strategy/2026-03-30/file.jsonl",
                "raw_line": 25,
                "error_type": "",
                "error_message": "",
            },
            {
                "event_id": "evt_same_ms_2",
                "session_key": "trace__trc_preview_same_ms",
                "ts": "2026-03-30 14:58:04.502",
                "runtime_node": "host:guardian",
                "component": "guardian_strategy",
                "node": "holding_scope_resolve",
                "status": "success",
                "event_type": "trace_step",
                "trace_id": "trc_preview_same_ms",
                "intent_id": "",
            ...
            {
                "event_id": "evt_same_ms_4",
                "session_key": "trace__trc_preview_same_ms",
                "ts": "2026-03-30 14:58:05.185",
                "runtime_node": "host:guardian",
                "component": "guardian_strategy",
                "node": "price_threshold_check",
                "status": "skipped",
                ...
                "decision_outcome": '{"outcome":"skip","reason_code":"sell_threshold_not_met"}',
                "payload_json": "{}",
                "metrics_json": "{}",
                "raw_json": "{}",
                "raw_file": "host_guardian/guardian_strategy/2026-03-30/file.jsonl",
...
def test_clickhouse_store_list_trace_steps_preserves_raw_line_order_with_same_millisecond_ts(
    monkeypatch,
):
    from freshquant.runtime_observability.clickhouse_store import (
        RuntimeObservabilityClickHouseStore,
    ...
    rows = [
        {
            "event_id": "evt_same_ms_desc_1",
            "session_key": "trace__trc_steps_same_ms",
            "ts": "2026-03-30 14:58:05.185",
            "runtime_node": "host:guardian",
            "component": "guardian_strategy",
            "node": "finish",
    ...
    monkeypatch.setattr(store, "ensure_schema", lambda: None)
    monkeypatch.setattr(store, "_select_rows", lambda query: rows)

    payload = store.list_trace_steps("trace__trc_steps_same_ms", limit=3)
