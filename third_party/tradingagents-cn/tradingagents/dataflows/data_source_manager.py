...
class DataSourceManager:
    ...
    @staticmethod
    def _run_async_sync(async_callable, *args, **kwargs):
        """Safely run provider coroutines from sync code."""
        try:
        ...
        try:
            ...
            if is_success:
                ...
                if isinstance(fallback_result, tuple):
                    fallback_text, fallback_source = fallback_result
                else:
                    fallback_text, fallback_source = fallback_result, None
                fallback_result = fallback_text
