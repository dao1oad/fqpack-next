...
class SimpleAnalysisService:
    ...
    def _normalize_single_analysis_request(
        self,
        request: SingleAnalysisRequest
    ) -> SingleAnalysisRequest:
        """Fill compatibility fields so downstream code sees a complete request."""
    ...
    async def create_analysis_task(
        ...
        try:
            # 生成任务ID
            request = self._normalize_single_analysis_request(request)
