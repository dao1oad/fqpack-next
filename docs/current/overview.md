...
- `RuntimeObservability` 当前是 Web UI 默认首页；`OrderManagement / PositionManagement / SubjectManagement / TpslManagement / StockControl / DailyScreening / KlineSlim / RuntimeObservability / Gantt*` 已统一到同一套 workbench / focus shell contract
