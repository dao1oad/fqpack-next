...
- `OrderManagement / PositionManagement / TpslManagement / KlineSlim / RuntimeObservability` 已统一为 workbench 风格页面
...
- PositionManagement 已改为统一三栏工作台：左栏门禁与一致性审计，中栏高密度标的总览，右栏选中标的工作区 + 最近决策
