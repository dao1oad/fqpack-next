...
- Gantt、Shouban30、KlineSlim、仓位管理、股票 TPSL 管理、Runtime Observability 等前端页面已落地。
...
- `morningglory/fqwebui/`
  - Vue Web UI，包括 Gantt、Shouban30、KlineSlim、仓位管理、股票 TPSL 管理、Runtime Observability 页面。
