...
- Gantt、Shouban30、KlineSlim、Runtime Observability、股票 TPSL 管理页、订单管理页等前端页面已落地。
...
- `morningglory/fqwebui/`
  - Vue Web UI，包括 Gantt、Shouban30、KlineSlim、Runtime Observability、股票 TPSL 管理、订单管理等页面。
