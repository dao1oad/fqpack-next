...
const resolutionEmptyDescription = computed(() => resolutionEndpointMissing.value ? '当前运行中的后端未暴露 reconciliation-workspace 接口，因此 Resolution 只能显示为空。' : '当前 symbol 暂无 gap / resolution / rejection 明细。')
