...
cdef extern from "chanlun/czsc.h":
    ...
    vector[StdBar] recognise_std_bars(int length, vector[float] h, vector[float] l, ChanOptions& chan_options)
    vector[float] recognise_swing(int length, vector[float] h, vector[float] l, ChanOptions& chan_options)
