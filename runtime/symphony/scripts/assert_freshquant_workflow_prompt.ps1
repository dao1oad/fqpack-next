...
$requiredPatterns = @(
    ...
    @{ Name = 'issue branch checkout rule'; Pattern = 'Before any non-`Todo` implementation turn starts,\s*switch the workspace to the deterministic issue branch instead of local `main`' },
